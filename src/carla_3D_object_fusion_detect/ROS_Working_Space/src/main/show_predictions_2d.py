...
from ....model.AVOD.wavedata.wavedata.tools.core import calib_utils
from ....model.AVOD.wavedata.wavedata.tools.obj_detection import obj_utils
from ....model.AVOD.wavedata.wavedata.tools.obj_detection import evaluation
from ....model.AVOD.wavedata.wavedata.tools.visualization import vis_utils

from ....model.AVOD import avod
from ....model.AVOD.avod.builders.dataset_builder import DatasetBuilder
from ....model.AVOD.avod.core import box_3d_encoder
from ....model.AVOD.avod.core import box_3d_projector
from ....model.AVOD.avod.core import anchor_projector
...
def main():
    ...
    """
    dataset_config = DatasetBuilder.copy_config(DatasetBuilder.KITTI_AVOD)
