...
output_dir = 'data/collages/collages-3fps-2-3'
            ...
            if os.path.isdir(inner_subfolder_path):
                ...
                for collage_index in range(num_collages):
                    ...
                    if frames:
                        ...
                        collage_width = 3 * frame_width + 4 * padding
                        ...
                        positions = [
                            ...
                            (padding, 2 * padding + frame_width),  # Top-middle
                            (padding, 3 * padding + 2 * frame_width),  # Top-right
                            (2 * padding + frame_height, padding),  # Bottom-left
                            (2 * padding + frame_height, 2 * padding + frame_width),  # Bottom-middle
                            (2 * padding + frame_height, 3 * padding + 2 * frame_width)  # Bottom-right
                        ]
